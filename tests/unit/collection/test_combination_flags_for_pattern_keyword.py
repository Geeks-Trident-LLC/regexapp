...
Run pytest in the project root to execute these tests:
    $ pytest tests/unit/collection/test_combination_flags_for_pattern_keyword.py
    or
    $ python -m pytest tests/unit/collection/test_combination_flags_for_pattern_keyword.py
"""
...
class TestCombinationFlagsForPatternKeyword:
