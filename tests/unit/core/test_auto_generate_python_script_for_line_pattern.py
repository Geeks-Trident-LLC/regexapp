...
def get_user_data():
    ...
    """
    user_data = """
        word(var_v1)  digits(var_v2, or_empty)  word(var_v3, or_empty)
    """
    return user_data
...
class TestAutoGeneratePythonTestScriptForLinePattern:
    """
    ...
    reference script stored in `tests/unit/data/core/snippet_script_for_line_pattern.txt`.
    ...
    verified_test_script_filename = 'snippet_script_for_line_pattern.txt'
