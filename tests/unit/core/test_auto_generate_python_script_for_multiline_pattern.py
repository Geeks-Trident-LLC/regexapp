...
Run pytest in the project root to execute these tests:
    $ pytest tests/unit/core/test_auto_generate_python_script_for_multiline_pattern.py
    or
    $ python -m pytest tests/unit/core/test_auto_generate_python_script_for_multiline_pattern.py
"""
...
class TestAutoGeneratePythonTestScriptForLinePatterns:
    ...
    reference script stored in `tests/unit/data/core/snippet_script_for_multiline_pattern.txt`.
    ...
    verified_test_script_filename = 'snippet_script_for_multiline_pattern.txt'
    ...
    def test_generating_python_script_using_dynamic_test_script_builder(self):
        ...
        the `is_line` flag is enabled (whole text regex generation).
        """
