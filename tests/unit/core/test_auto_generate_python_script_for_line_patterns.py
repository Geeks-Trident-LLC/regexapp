...
Run pytest in the project root to execute these tests:
    $ pytest tests/unit/core/test_auto_generate_python_script_for_line_patterns.py
    or
    $ python -m pytest tests/unit/core/test_auto_generate_python_script_for_line_patterns.py
"""
