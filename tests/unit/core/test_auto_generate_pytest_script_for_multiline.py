...
class TestAutoGeneratePytestScriptForMultiline:
    """
    ...
    reference script stored in `tests/unit/data/pytest_script_for_multiline.txt`.
    ...
    verified_test_script_filename = 'pytest_script_for_multiline.txt'
